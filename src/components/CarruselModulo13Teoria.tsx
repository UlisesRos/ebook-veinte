...
const IMAGES = [
  { src: '/modulo13/teoria.png', alt: 'Collage de telas y prendas estampadas combinando colores y texturas' },
  { src: '/modulo13/vestido-rayas-pez.png', alt: 'Vestido a rayas rojas y blancas con estampa de peces' },
  { src: '/modulo13/vestido-pez-koi.png', alt: 'Vestido blanco con estampa de peces koi en rojo' },
  { src: '/modulo13/vestido-sardine.png', alt: 'Vestido blanco y rojo con estampa de sardinas' },
  { src: '/modulo13/tote-bags-estampados.png', alt: 'Tote bags con estampas de peces y langostas combinadas con rayas' },
  { src: '/modulo13/tote-bag-sardines.png', alt: 'Tote bag a rayas verdes con estampa de lata de sardinas' },
  { src: '/modulo13/neceseres-pickleball.png', alt: 'Neceseres a rayas rosas y verdes combinados con accesorios de pickleball' },
] as const;
...
export function CarruselModulo13Teoria() {
