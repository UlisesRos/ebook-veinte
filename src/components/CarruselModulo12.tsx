...
const IMAGES = [
  { src: '/modulo12/practica1.png', alt: 'Bolso soga a rayas rosa y marrón con cordón de algodón' },
  { src: '/modulo12/practica2.png', alt: 'Bolso soga a rayas rosa y naranja con cordón de algodón' },
  { src: '/modulo12/bolsos-soga.png', alt: 'Dos bolsos soga terminados, uno a rayas rosa y marrón y otro a rayas rosa y naranja' },
  { src: '/modulo12/teoria.png', alt: 'Bolso soga de gamuza marrón con sol bordado y cordón trenzado' },
] as const;
...
export function CarruselModulo12() {
