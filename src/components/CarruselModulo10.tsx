...
const IMAGES = [
  { src: '/modulo10/canasta.png', alt: 'Cesta cuadrada de rayas rosas terminada con borde de encaje' },
  { src: '/modulo10/canasta2.png', alt: 'La cesta usada como organizador de cosmética sobre una bacha' },
  { src: '/modulo10/tecnicas.png', alt: 'Técnicas para sujetar telas sin que se marquen' },
  { src: '/modulo10/alfileres.png', alt: 'Comparativa de alfileres, clips, pesas para molde e hilvanado' },
  { src: '/modulo10/molde.png', alt: 'Cómo dejar 1 cm de margen de costura alrededor del molde' },
] as const;
...
export function CarruselModulo10() {
