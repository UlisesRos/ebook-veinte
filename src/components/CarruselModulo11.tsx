...
const IMAGES = [
  { src: '/modulo11/horno.png', alt: 'Manopla de ondas rojas colgada de la puerta del horno' },
  { src: '/modulo11/maquillaje.png', alt: 'La misma manopla como organizador de brochas en el baño' },
  { src: '/modulo11/maquillaje2.png', alt: 'Manopla colgada de una barra con las brochas en su bolsillo' },
  { src: '/modulo11/molde.png', alt: 'Manos trazando moldes sobre papel madera junto a una tijera de sastre' },
  { src: '/modulo11/molde3.png', alt: 'Moldes colgados con el nombre de la pieza y la cantidad a cortar' },
  { src: '/modulo11/molde4.png', alt: 'Moldes con sus especificaciones escritas y pesas para sujetarlos' },
  { src: '/modulo11/molde2.png', alt: 'Rollos de papel madera con moldes trazados' },
] as const;
